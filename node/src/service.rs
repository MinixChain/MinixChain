...
use minix_runtime::{self, opaque::Block, RuntimeApi};
...
native_executor_instance!(
    pub Executor,
    minix_runtime::api::dispatch,
    minix_runtime::native_version,
...
pub fn new_full(mut config: Configuration) -> Result<TaskManager, ServiceError> {
    ...
    let (grandpa_block_import, grandpa_link) = consensus_result;
