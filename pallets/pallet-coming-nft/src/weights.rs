...
// --heap-pages=4096
// --output=./pallets/pallet-coming-nft/src/weights.rs
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
    ...
    fn set_approval_for_all() -> Weight {
        (16_268_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
    }
}
...
impl WeightInfo for () {
    ...
    fn set_approval_for_all() -> Weight {
        (16_268_000 as Weight).saturating_add(RocksDbWeight::get().writes(1 as Weight))
    }
}
